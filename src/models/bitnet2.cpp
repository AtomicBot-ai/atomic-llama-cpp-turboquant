...
void llama_model_bitnet2::load_arch_hparams(llama_model_loader & ml) {
...
void llama_model_bitnet2::load_arch_tensors(llama_model_loader &) {
    LLAMA_LOAD_LOCALS;
...
std::unique_ptr<llm_graph_context> llama_model_bitnet2::build_arch_graph(const llm_graph_params & params) const {
    return std::make_unique<graph>(*this, params);
}

llama_model_bitnet2::graph::graph(const llama_model & model, const llm_graph_params & params) : llm_graph_context(params) {
