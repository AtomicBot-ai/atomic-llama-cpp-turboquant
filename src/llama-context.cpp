...
llama_context * llama_init_from_model(
    ...
    if (params.kvarn.type != LLAMA_KVARN_TYPE_DISABLED) {
        if (params.ctx_type != LLAMA_CONTEXT_TYPE_DEFAULT) {
            ...
            if (const char * reason = llama_kvarn_validate_runtime(params.kvarn, requirements)) {
                ...
                LLAMA_LOG_INFO("%s: KVarN layers use structured records; non-KVarN layers use type_k = %s, type_v = %s\n",
    ...
    if (params.flash_attn_type != LLAMA_FLASH_ATTN_TYPE_DISABLED && ggml_is_quantized(params.type_k)) {
        ...
        const bool k_is_turbo = (params.type_k == GGML_TYPE_TURBO2_0 ||
                                 ...
                                 params.type_k == GGML_TYPE_TURBO3_TCQ ||
                                 params.type_k == GGML_TYPE_TURBO2_TCQ);
    ...
    if (params.flash_attn_type != LLAMA_FLASH_ATTN_TYPE_DISABLED && ggml_is_quantized(params.type_v)) {
        ...
        const bool v_is_turbo = (params.type_v == GGML_TYPE_TURBO2_0 ||
                                 ...
                                 params.type_v == GGML_TYPE_TURBO3_TCQ ||
                                 params.type_v == GGML_TYPE_TURBO2_TCQ);
    ...
    if (params.flash_attn_type == LLAMA_FLASH_ATTN_TYPE_DISABLED &&
        (params.type_k == GGML_TYPE_TURBO2_0 || params.type_k == GGML_TYPE_TURBO3_0 || params.type_k == GGML_TYPE_TURBO4_0 || params.type_k == GGML_TYPE_TURBO3_TCQ || params.type_k == GGML_TYPE_TURBO2_TCQ ||
         params.type_v == GGML_TYPE_TURBO2_0 || params.type_v == GGML_TYPE_TURBO3_0 || params.type_v == GGML_TYPE_TURBO4_0 || params.type_v == GGML_TYPE_TURBO3_TCQ || params.type_v == GGML_TYPE_TURBO2_TCQ)) {
